...
\begin{adjustbox}{width=\textwidth}
    ...
    \midrule
    \endfirsthead
    \multicolumn{9}{l}{Continuação da Tabela}{\parbox{\LTcapwidth}{\small\singlespacing\textbf{Tabela \thetable} -- Eventos Sismicos}} \\
    \toprule
    {ID} & {Hora de Origem (UTC)} & {Longitude} & {Latitude} & {UTM X} & {UTM Y} & {MLv} & {Energia} & {Cat} \\
    \midrule
    \endhead
    ...
    % Continue adicionando mais linhas de dados conforme necessário
    \bottomrule
