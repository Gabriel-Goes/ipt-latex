...
\cancelaDoc{Relatório nº 1} % Descomente para opção cancela e substitui
\data{14 de dezembro de 2023}
\titulo{Análise de métricas obtidas para os eventos rede simológica de Itá/Machadinho.}
\unidade{Cidades Infraestruturas e Meio Ambiente}{CIMA}
\lab{Seção de Obras Civis - SOC}
\periodo{01 de janeiro de 2020}{31 de dezembro de 2023}
