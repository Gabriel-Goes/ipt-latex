...
\begin{figure}[htb!]
    ...
    \includegraphics[width=1.0\textwidth]{./boletim/ita/figuras/completude_SP7.png} % Substitua pelo nome da imagem e ajuste o tamanho
    %\includegraphics[width=1.0\textwidth]{./boletim/ita/figuras/completude_SP7.png}
    \end{mdframed}
    \caption*{Fonte: IPT}
