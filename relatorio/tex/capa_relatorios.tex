...
\titulo{\textbf{Análise dos registros obtidos entre}} \\
\PeriodoAnalise{01 de dezembro de 2022}{30 de junho de 2023} \\
%\textbf{na estação Sismológica SP7, Salto Pilão, SC}
