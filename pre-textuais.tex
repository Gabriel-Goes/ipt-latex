...
\pagenumbering{Roman}
\setcounter{page}{1}
\fancyhead[R]{\textbf{ Relatório Técnico nº XXX XXX {\thepage}}} % Número de página no canto superior direito
...
\fancyhead[R]{\textbf{ Relatório Técnico nº XXX XXX {\thepage}/\pageref{LastPage}}} % Número de página no canto superior direito
...
\begin{table}[htbp]
    ...
    \begin{tabular}{ccccccccc} % Defina o número de colunas de acordo com seu arquivo CSV
        ...
        \midrule
        \csvreader[
            no head, % Não usar cabeçalho do CSV
            late after line=\\, % Quebra de linha após cada linha do CSV
            late after last line=\\, % Quebra de linha após a última linha
	    %filter test=\ifnumless{\thecsvinputline}{2}{} % Ignora as duas primeiras linhas do CSV
    ]{events.csv}{}{%[
